...
$_allowed = ['https://reformaeat.ru', 'https://akirzhinov07-beep.github.io'];
$_origin  = $_SERVER['HTTP_ORIGIN'] ?? '';
header('Access-Control-Allow-Origin: ' . (in_array($_origin, $_allowed) ? $_origin : 'https://reformaeat.ru'));
